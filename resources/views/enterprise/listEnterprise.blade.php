            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        ...
                        <a href="{{ route('enterprise.desabled.list') }}" class="btn-lg btn btn-sm btn-warning">Empresas Desabilitadas</a>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <a class="dropdown-item" href="{{ route('enterprise.edit', $interprise->id) }}">Editar</a>
                                                    <a class="dropdown-item" onclick="return confirm('Essa empresa sera desabilitada de nossos registros, deseja continuar?')" href="{{ route('enterprise.desabled',  $interprise->id)}}">Excluir</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <div class="card-footer py-4">
                        <nav aria-label="...">
                            <ul class="pagination justify-content-end mb-0">
                                {{ $enterprises->links('pagination::bootstrap-4') }}
                            </ul>
                        </nav>
                    </div>
                </div>
