...
@section('content')
    ...
    'title' => __('Atualizar empresa'),
    'description' => __('Verifique os campos abaixo para atualização!'),
    'class' => 'col-lg-12'
    ])
        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="card bg-secondary shadow">
                    <div class="card-body">
                        <form method="post" action="{{ route('enterprise.edit.show', $query->id) }}" autocomplete="off">
                            @csrf
                            @method('PUT')
                            @if (session('status'))
                                        ...
                                        <div class="tab-content" id="myTabContent">
                                            <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel"
                                                ...
                                                <input class="form-control form-control-alternative"
                                                    onblur="pesquisacnpj(this.value);" name="cnpj" id="cnpj" required
                                                    type="text" value="{{ $query->cnpj }}">
                                                <br />
                                                ...
                                                <input class="form-control form-control-alternative" name="email" id="email"
                                                    type="email" value="{{ $query->email }}" required>
                                                <br />
                                            ...
                                            <div class="tab-pane fade" id="tabs-icons-text-2" role="tabpanel"
                                                ...
                                                <input class="form-control form-control-alternative"
                                                    onblur="pesquisacep(this.value);" name="cep" id="cep" type="text"
                                                    required value="{{ $query->cep }}">
                                                <br />
                                                ...
                                                <input class="form-control form-control-alternative" id="phone" name="phone"
                                                    id="telefone" required type="text" required value="{{ $query->phone }}">
                                                <br />
                                            ...
                                            <div class="tab-pane fade" id="tabs-icons-text-3" role="tabpanel"
                                                ...
                                                <div class="row text-center">
                                                    <div class="col-md-4 custom-control custom-radio mb-3">
                                                        @if ($query->segmento === 'Produto')
                                                            <input name="segmento" value="Produto" checked=''
                                                                class="custom-control-input" id="customRadio1" type="radio">
                                                        @else
                                                            <input name="segmento" value="Produto"
                                                                class="custom-control-input" id="customRadio1" type="radio">
                                                        @endif
                                                    ...
                                                    <div class="col-md-4 custom-control custom-radio mb-3">
                                                        @if ($query->segmento === 'Serviço')
                                                            <input name="segmento" value="Serviço" checked=''
                                                                class="custom-control-input" id="customRadio2" type="radio">
                                                        @else

                                                            <input name="segmento" value="Serviço"
                                                                class="custom-control-input" id="customRadio2" type="radio">
                                                        @endif
                                                        <label class="custom-control-label"
                                                    ...
                                                    <div class="col-md-4 custom-control custom-radio mb-3">
                                                        @if ($query->segmento === 'Produto e Serviço')
                                                            <input name="segmento" value="Produto e Serviço" checked=''
                                                ...
                                                <div class="text-center">
                                                    <button type="submit"
                                                        class="btn btn-success mt-4">{{ __('Atualizar') }}</button>
                                                </div>
